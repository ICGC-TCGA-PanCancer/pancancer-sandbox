...
def create_rna_seq_entry(analysis_attrib, gnos_analysis):
    rna_seq_entry = {
        "alignment":{
         "star_aligned":{
            "normal_alignment":{
               ...
               "star_version": analysis_attrib.get('STAR_version')
               "gnos_info":{
                  "gnos_repo":[
                     "https://gtrepo-ebi.annailabs.com/"
                  ],
                  "gnos_id":"8dc9a8c9-eb12-4a71-884e-9b5c49909330",
                  "bam_file_name":"dfd",
                  "bam_file_size":432412,
                  "gnos_last_modified":[
                     "2015-04-10T06:25:44+00:00"
                  ]
               }
            },
            "tumor_alignment":[
